...
final class HistoryParser {
    ...
    func parseSessionsFromProjects() -> [Session] {
        ...
        for projectDir in projectDirs {
            ...
            guard let sessionFiles = try? fileManager.contentsOfDirectory(atPath: projectSessionDir) else {
                continue
            }
            ...
            for sessionFile in sessionFiles {
                ...
                if let sessionData = parseSessionFile(path: sessionFilePath, sessionId: sessionId, projectPath: projectPath) {
